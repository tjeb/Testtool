...
public class SchematronValidator {
    ...
    public SchematronValidator(File r, String transformerFile) {
        ...
        if (r == null) {
            log.info("File with Schematron rules is NULL!");
    ...
    public SchematronValidator(List<File> rs, String transformerFile) {
        ...
        if (rs == null) {
            log.info("List of Schematron rules is NULL!");
     ...
     * @throws ValidationError              thrown if the document is not valid.
    ...
    public void validate(String xmlDoc) {
        ...
        try {
            ...
            if (!EMPTY_SCHEMATRON_RESULT.equals(schematronResult)
                ...
                throw new ValidationError(formatXML(schematronResult));
            }

        } catch (TransformerFactoryConfigurationError e) {
            log.info("TransformerFactoryConfigurationError during SchematronValidation, " + e.getMessage());
            if (!EMPTY_SCHEMATRON_RESULT.equals(schematronResult)
                    && !XML_HEADER.equals(schematronResult)) {
                log.info("Result is not empty!\n" + schematronResult);
             ...
             * log.info("Result is not empty! "+schematronResult); throw new
    ...
    public void validate(InputStream xmlDoc) {
        ...
        try {
            ...
            if (!EMPTY_SCHEMATRON_RESULT.equals(schematronResult)
                    && !XML_HEADER.equals(schematronResult)) {
                log.info("Result is not empty! " + schematronResult);
                throw new ValidationError(formatXML(schematronResult));
            }

        } catch (TransformerFactoryConfigurationError e) {
            log.severe("TransformerFactoryConfigurationError during SchematronValidation, " + e.getMessage());
            if (!EMPTY_SCHEMATRON_RESULT.equals(schematronResult)
                    && !XML_HEADER.equals(schematronResult)) {
                log.info("Result is not empty! " + schematronResult);
                throw new ValidationError(schematronResult);
     ...
     * <p/>
     * the response that will be validated
    ...
    public String validateSchematron(String xmlDoc, File rules) {
        ...
        try {
            ...
            log.info("Validating Schematron: TransformationException: " + e);
            throw new ValidationError(e);
        } catch (UnsupportedEncodingException e) {
            log.info("Validating Schematron: UnsupportedEncodingException: " + e);
            throw new ValidationError(e);
        }
    }
    ...
    public String formatXML(String xml) {
        ...
        try {
            ...
            log.info("TransformerFactoryConfigurationError:\n" + xml);
        } catch (TransformerException e) {
            log.info("TransformerException:\n" + xml);
        }
