...
/**
 * TOTP implementation is loaded from @{link https://github.com/parkghost/TOTP-authentication-demo}
 *
 * @since 0.2
 */
@Component("totp")
public class TOTP {
    ...
    public int generateTOTP(byte[] key, long time, int digits, String crypto) {
